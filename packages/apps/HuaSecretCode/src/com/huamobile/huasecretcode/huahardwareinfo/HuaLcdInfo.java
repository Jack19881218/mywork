...
public class HuaLcdInfo {
	...
	static {
		...
		mHashMapIdIc.put(0x1901A, "OTM1901A");
		...
		mHashMapIdIc.put(0x9881, "ILI9881");
		mHashMapIdIc.put(0x9882, "ILI9881");
		...
		mHashMapIdIc.put(0x8394D, "HX8394D");
		...
		mHashMapNameId.put("qcom,mdss_dsi_otm1901a_1080p_video", 0x1901A);

		mHashMapIdIc.put(0x307, "FL10802");
		mHashMapIdIc.put(0x308, "FL10802");
		mHashMapIdIc.put(0x1281, "FL11280");


		mHashMapNameId.put("marvell,lcd_fl10802_hsd_ho9021", 0x307);
		mHashMapNameId.put("marvell,lcd_fl10802_cpt_ho9021", 0x308);
		mHashMapNameId.put("marvell,lcd_ili9881_cpt_zq9077", 0x9881);
		mHashMapNameId.put("marvell,lcd_ili9881_ivo_zq9077", 0x9882);
	}

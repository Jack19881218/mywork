...
public class HuaTouchscreenVendorInfo {
	...
	static {
		...
		mHashMapShortName.put(R.string.vendor_name_junda_2, "junda");
		mHashMapShortName.put(R.string.vendor_name_helitai, "helitai");
		mHashMapShortName.put(R.string.vendor_name_temeike, "temeike");
		mHashMapShortName.put(R.string.vendor_name_huaxingda, "huaxingda");
		mHashMapShortName.put(R.string.vendor_name_rongshibao, "rongshibao");
		...
		if (Build.BOARD.equals("h1")) {
			...
			mHashMapVendor.put(0x02, R.string.vendor_name_rongshibao);
		} else if (Build.DEVICE.equals("pxa1L88H5")) {
			mHashMapVendor.put(0x02, R.string.vendor_name_rongshibao);
		} else if (Build.DEVICE.equals("pxa1L88H6")) {
			mHashMapVendor.put(0x02, R.string.vendor_name_rongshibao);
		} else if (Build.DEVICE.equals("pxa1908FF")) {
			mHashMapVendor.put(0x0a, R.string.vendor_name_junda);
			mHashMapVendor.put(0x03, R.string.vendor_name_junda);
		} else if (Build.DEVICE.equals("P108V30") || Build.DEVICE.equals("LA2-S") || Build.DEVICE.equals("H608Z01")) {
			mHashMapVendor.put(0x0c, R.string.vendor_name_junda_2);
			mHashMapVendor.put(0x0d, R.string.vendor_name_junda_2);
		} else if (Build.DEVICE.equals("Coolpad8106")) {
			mHashMapVendor.put(0x0a, R.string.vendor_name_helitai);
			mHashMapVendor.put(0x0b, R.string.vendor_name_junda_2);
			mHashMapVendor.put(0x0c, R.string.vendor_name_junda_2);
